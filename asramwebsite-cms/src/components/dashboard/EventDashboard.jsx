    ...
    return (
        <div className="flex flex-col w-full h-full font-['Montserrat'] bg-white pb-10 gap-y-[20px]"
            ...
            <style>{`
                ...
                /* Title Specifics */
                .event-title-editor .ck-editor__editable {
                    min-height: 91px;
                ...
                /* Content Specifics */
                .event-content-editor .ck-editor {
                    display: flex;
                    flex-direction: column;
                    height: 100%;
                }
                .event-content-editor .ck-editor__main {
                    display: flex;
                    flex-direction: column;
                    flex-grow: 1;
                }
                .event-content-editor .ck-editor__editable {
                    min-height: 292px;
                    padding: 20px !important;
                    font-size: 16px;
                    flex-grow: 1;
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px]" style={{ minHeight: '292px' }}>
                    {/* Summary Text */}
                    <div style={{
                        width: '100%',
                        height: '100%'
                        ...
                        <div
                            className="event-content-editor"
                            style={{
                                display: 'flex',
                                flexDirection: 'column',
                                height: '100%',
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px]" style={{ minHeight: '292px' }}>
                    ...
                    <div style={{
                        ...
                        <div className="flex items-center gap-2 text-[#223f7f]" style={{ marginBottom: '5px' }}>
