...
const ArrowLeftIcon = () => (
    <svg width="10" height="20" viewBox="0 0 10 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M7.95668 5.48125L7.07251 4.59792L2.25668 9.41208C2.17905 9.48922 2.11744 9.58095 2.0754 9.682C2.03336 9.78304 2.01172 9.8914 2.01172 10.0008C2.01172 10.1103 2.03336 10.2186 2.0754 10.3197C2.11744 10.4207 2.17905 10.5124 2.25668 10.5896L7.07251 15.4062L7.95584 14.5229L3.43584 10.0021L7.95668 5.48125Z" fill="#3A3A3A" />
    </svg>
...
const Sidebar = ({ isOpen = false, onClose }) => {
    ...
    React.useEffect(() => {
        ...
        } else if (path === '/dashboard-approvals') {
            setActiveItem('Content Approvals');
    ...
    const handleItemClick = (label) => {
        ...
        } else if (label === 'Content Approvals') {
        ...
        >
            ...
            <div className="flex-1 flex flex-col overflow-y-auto no-scrollbar overflow-x-hidden">
                ...
                <SidebarItem
                    ...
                    active={activeItem === 'Content Approvals'}
                    onClick={() => handleItemClick('Content Approvals')}
                />
