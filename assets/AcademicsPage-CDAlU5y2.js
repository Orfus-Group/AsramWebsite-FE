import{j as e}from"./animations-D3tOYQY4.js";import{r as l}from"./vendor-CEFHwVPC.js";import{P as x,T as t,u as S}from"./index-DVVNfkXr.js";import{I as A}from"./IconFullArrow-l6J0f89Q.js";import{b as M,W as L}from"./CheckMarkIcon-7lzDza6o.js";import{B as u}from"./button-D1tk62L1.js";import{S as H}from"./StudentVoices-BuH11Lpk.js";import{I}from"./IconArrowRight-C_dN895v.js";import{M as c}from"./MotionSection-BH0xkWDy.js";const B="data:image/svg+xml,%3csvg%20width='18'%20height='18'%20viewBox='0%200%2018%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M8.88135%204.44043V8.88122L11.8419%2010.3615'%20stroke='%23191919'%20stroke-opacity='0.75'%20stroke-width='1.48026'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.8813%2016.2831C12.9689%2016.2831%2016.2826%2012.9694%2016.2826%208.88178C16.2826%204.79415%2012.9689%201.48047%208.8813%201.48047C4.79366%201.48047%201.47998%204.79415%201.47998%208.88178C1.47998%2012.9694%204.79366%2016.2831%208.8813%2016.2831Z'%20stroke='%23191919'%20stroke-opacity='0.75'%20stroke-width='1.48026'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",P=[{tag:"Undergraduate",title:"B.Sc Nursing",years:"4 Years",seats:"100 Seats",description:"Comprehensive undergraduate program combining theoretical knowledge with extensive clinical practice. Perfect for students seeking a professional nursing career.",highlights:["Clinical rotations in multispeciality hospital","Research opportunities","International nursing standards"]},{tag:"Diploma",title:"General Nursing & Midwifery",years:"3 Years",seats:"60 Seats",description:"Intensive diploma program focused on nursing fundamentals and midwifery. Ideal for those wanting to enter the nursing profession quickly.",highlights:["Hands-on clinical training","Obstetrics & gynecological focus","Community health experience"]},{tag:"Postgraduate",title:"M.Sc Nursing",years:"2 Years",seats:"30 Seats",description:"Advanced nursing education with specializations in Medical-Surgical, Obstetrics, Pediatrics, Community Health, and Psychiatric Nursing.",highlights:["Research & thesis work","Leadership development","Academic & clinical roles"]}];function E(){return e.jsxs(x,{bg:t.bg.white,paddingClass:"py-[80px]",children:[e.jsx("h2",{className:`
    ...
    `,style:{color:"#191919BF"},children:[e.jsx(M,{className:"shrink-0 mt-[2px]"}),e.jsx("span",{className:`${t.font.family} leading-[18px]`,children:n})]},i))})]}),e.jsxs("button",{className:`
        ...
        `,children:"Shape Your Career in Nursing"}),e.jsxs("div",{className:"w-full flex flex-col lg:flex-row items-center justify-start gap-[40px] lg:gap-[90px]",children:[e.jsx("div",{className:`\r
            ...
            rounded-[8px]\r
            overflow-hidden\r
          `,children:e.jsx("img",{src:V,alt:"Nursing Career",loading:"lazy",decoding:"async",className:"w-full h-full object-cover"})}),e.jsxs("div",{className:`\r
            flex-1\r
            w-full\r
            lg:max-w-[588px]\r
            grid\r
            grid-cols-2\r
            gap-[23.7px]\r
          `,children:[e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(W,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"20+"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Years of Excellence"})]}),e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(R,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"377+"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Active Students"})]}),e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(z,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"95%"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Placement Success"})]}),e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(D,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"INC"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Approved Programs"})]})]})]})]})}function q(){return e.jsx(x,{bg:"transparent",sectionClassName:"flex justify-center",paddingClass:"pb-[80px]",children:e.jsxs("div",{className:`\r
          bg-[#EEF2F7]\r
          rounded-[16.2px]\r
  ...
  `,style:{backgroundColor:"#EEF2F7",color:t.color.dark},children:n+1}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:`
      ...
      `,style:{backgroundColor:"#EEF2F7"},children:[e.jsxs("div",{className:`\r
        ...
        `,style:{backgroundColor:t.color.primary},children:[s,"      "]}),e.jsx("h3",{className:`
          ...
          leading-[29.61px]
          text-[${t.color.secondary}]
        `,children:r}),e.jsxs("p",{className:"text-[14px] leading-[20px] mt-[6px]",style:{color:"#191919BF"},children:[n,e.jsx("br",{}),i]})]})}function b({count:s,label:r}){const[n,i]=l.useState("0"),p=l.useRef(null),m=l.useRef(!1);l.useEffect(()=>{const d=p.current,o=new IntersectionObserver(a=>{a[0].isIntersecting&&!m.current&&(m.current=!0,f())},{threshold:.4});return d&&o.observe(d),()=>o.disconnect()},[]);const f=()=>{const d=parseInt(s.replace(/\D/g,""),10),o=s.replace(/[0-9]/g,"");if(isNaN(d)){i(s);return}const a=1200,h=performance.now(),g=j=>{const w=Math.min((j-h)/a,1),y=Math.floor(w*d);i(y+o),w<1&&requestAnimationFrame(g)};requestAnimationFrame(g)};return e.jsxs("div",{className:"flex flex-col items-center text-center",ref:p,children:[e.jsx("span",{className:`
          ${t.font.family}
          ${t.font.weight.bold}
          text-[35.53px]
          leading-[39.47px]
        ...
        `,children:n}),e.jsx("span",{className:`
          ...
          leading-[23.68px]
          font-regular
        `,style:{color:"#191919BF"},children:r})]})}const le="/AsramWebsite-FE/assets/asramacademicsbanner-Rp9-HRkA.png",ge=()=>{const{setHero:s,hideHero:r}=S();return l.useLayoutEffect(()=>(s({title:e.jsx("span",{className:"font-montserrat font-bold text-[32px] md:text-[40px] leading-[1.2] text-white",children:"Build a Career in Healthcare"}),bgImage:le,children:e.jsx(e.Fragment,{children:e.jsx("p",{className:"font-montserrat font-medium text-[16px] md:text-[22px] leading-[1.4] text-white max-w-[520px] mb-6",children:"Structured medical education supported by experienced faculty, advanced laboratories, and real-world clinical exposure."})})}),()=>r()),[s,r]),e.jsx(e.Fragment,{children:e.jsxs(e.Fragment,{children:[e.jsx(c,{children:e.jsx(E,{})}),e.jsx(c,{delay:.1,children:e.jsx(O,{})}),e.jsx(c,{delay:.1,children:e.jsx(L,{})}),e.jsx(c,{delay:.2,children:e.jsx(q,{})}),e.jsx(c,{delay:.2,children:e.jsx(Q,{})}),e.jsx(c,{delay:.3,children:e.jsx(H,{})}),e.jsx(c,{delay:.3,children:e.jsx(se,{})}),e.jsx(c,{delay:.4,children:e.jsx(oe,{})})]})})};export{ge as default};
