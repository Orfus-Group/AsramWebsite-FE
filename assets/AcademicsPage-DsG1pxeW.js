import{j as e}from"./animations-D3tOYQY4.js";import{r as l}from"./vendor-CEFHwVPC.js";import{P as x,T as t,u as S}from"./index-5k6KKZlh.js";import{I as A}from"./IconFullArrow-l6J0f89Q.js";import{b as M,W as L}from"./CheckMarkIcon-CmlqYU7u.js";import{B as u}from"./button-CRbMnYGY.js";import{S as H}from"./StudentVoices-BPa2ESpT.js";import{I}from"./IconArrowRight-C_dN895v.js";import{T as B}from"./TypedText-PwL1-WUa.js";import{M as c}from"./MotionSection-BH0xkWDy.js";const P="data:image/svg+xml,%3csvg%20width='18'%20height='18'%20viewBox='0%200%2018%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M8.88135%204.44043V8.88122L11.8419%2010.3615'%20stroke='%23191919'%20stroke-opacity='0.75'%20stroke-width='1.48026'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.8813%2016.2831C12.9689%2016.2831%2016.2826%2012.9694%2016.2826%208.88178C16.2826%204.79415%2012.9689%201.48047%208.8813%201.48047C4.79366%201.48047%201.47998%204.79415%201.47998%208.88178C1.47998%2012.9694%204.79366%2016.2831%208.8813%2016.2831Z'%20stroke='%23191919'%20stroke-opacity='0.75'%20stroke-width='1.48026'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",E=[{tag:"Undergraduate",title:"B.Sc Nursing",years:"4 Years",seats:"100 Seats",description:"Comprehensive undergraduate program combining theoretical knowledge with extensive clinical practice. Perfect for students seeking a professional nursing career.",highlights:["Clinical rotations in multispeciality hospital","Research opportunities","International nursing standards"]},{tag:"Diploma",title:"General Nursing & Midwifery",years:"3 Years",seats:"60 Seats",description:"Intensive diploma program focused on nursing fundamentals and midwifery. Ideal for those wanting to enter the nursing profession quickly.",highlights:["Hands-on clinical training","Obstetrics & gynecological focus","Community health experience"]},{tag:"Postgraduate",title:"M.Sc Nursing",years:"2 Years",seats:"30 Seats",description:"Advanced nursing education with specializations in Medical-Surgical, Obstetrics, Pediatrics, Community Health, and Psychiatric Nursing.",highlights:["Research & thesis work","Leadership development","Academic & clinical roles"]}];function V(){return e.jsxs(x,{bg:t.bg.white,paddingClass:"py-[80px]",children:[e.jsx("h2",{className:`
        ...
        `,children:"Programs Offered"}),e.jsx("div",{className:`\r
          ...
          gap-[40px]\r
          w-full\r
        `,children:E.map((s,r)=>e.jsxs("div",{className:`
              w-full
              h-[619.74px]
              ${t.radius.lg}
              overflow-hidden
    ...
    `,style:{color:"#191919BF"},children:[e.jsx(M,{className:"shrink-0 mt-[2px]"}),e.jsx("span",{className:`${t.font.family} leading-[18px]`,children:n})]},i))})]}),e.jsxs("button",{className:`
        ...
        `,children:"Shape Your Career in Nursing"}),e.jsxs("div",{className:"w-full flex flex-col lg:flex-row items-center justify-start gap-[40px] lg:gap-[90px]",children:[e.jsx("div",{className:`\r
          ...
          `,children:e.jsx("img",{src:W,alt:"Nursing Career",loading:"lazy",decoding:"async",className:"w-full h-full object-cover"})}),e.jsxs("div",{className:`\r
            ...
            grid-cols-2\r
            gap-[23.7px]\r
          `,children:[e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(R,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"20+"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Years of Excellence"})]}),e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(z,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"377+"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Active Students"})]}),e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(D,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"95%"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Placement Success"})]}),e.jsxs("div",{className:"bg-white flex flex-col items-center justify-center border border-transparent hover:shadow-md transition-shadow aspect-[282/171] rounded-[9.9px]",children:[e.jsx(O,{}),e.jsx("span",{className:"mt-[15px] text-[#223F7F] font-bold font-montserrat text-center",style:{fontSize:"29.6px",lineHeight:"1.2"},children:"INC"}),e.jsx("span",{className:"mt-[5px] text-center font-montserrat font-medium",style:{fontSize:"14px",color:"#555555"},children:"Approved Programs"})]})]})]})]})}function q(){return e.jsx(x,{bg:"transparent",sectionClassName:"flex justify-center",paddingClass:"pb-[80px]",children:e.jsxs("div",{className:`\r
          bg-[#EEF2F7]\r
          rounded-[16.2px]\r
        ...
        `,children:[e.jsxs("div",{className:"flex flex-col w-full lg:w-[48%] max-w-[535px]",children:[e.jsx("h3",{className:`
            ...
            max-w-[545px]\r
            my-auto\r
          `,children:[{value:"100+",label:"B.Sc Seats"},{value:"60+",label:"GNM Seats"},{value:"30+",label:"M.Sc Seats"},{value:"56+",label:"Faculty Members"}].map((s,r)=>e.jsxs("div",{className:`\r
                bg-white\r
                rounded-[8px]\r
                ...
                w-full\r
              `,children:[e.jsx(Z,{value:s.value,className:`
                  ${t.font.family}
                  ${t.font.weight.bold}
                  text-[#223F7F]
        ...
        `,children:"Nursing Program Admissions"}),e.jsxs("div",{className:"flex flex-col gap-[24px]",children:[e.jsx("h3",{className:`
          ...
          `,children:"Admission Requirements"}),e.jsx("div",{className:`\r
            ...
            gap-[31.58px]\r
          `,children:K.map((s,r)=>e.jsxs("div",{className:`\r
                bg-white\r
                rounded-[12px]\r
                border\r
                p-[20px]\r
              ...
              mb-[30px]
              text-[${t.color.secondary}]
            `,children:"Important Dates"}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-[23.68px] gap-y-[20px]",children:Q.map((s,r)=>e.jsxs("div",{className:"flex flex-col items-center text-center",children:[e.jsx("p",{className:`
                    ${t.font.family}
                    ${t.font.weight.medium}
                    text-[#191919]
                    text-[18px]
        ...
        `,children:[e.jsx("div",{className:`\r
            ...
            rounded-[12px] \r
            overflow-hidden\r
          `,children:e.jsx("img",{loading:"lazy",decoding:"async",src:G,className:"w-full lg:w-[589px] h-[389px] object-cover rounded-[12px]"})}),e.jsxs("div",{className:`\r
            flex-1\r
            flex flex-col\r
            gap-[20px]\r
      ...
      `,style:{color:t.color.text.researchMuted},children:"Start your application today and take the first step toward an exceptional nursing education. Our admissions team is here to support you throughout the process."}),e.jsxs("div",{className:"flex flex-wrap gap-[16px]",children:[e.jsx(u,{bg:t.color.primary,color:"white",rounded:"8px",textSize:"text-[14px]",leading:"leading-[20px]",width:"206px",height:"44px",customPadding:"px-[22px] py-[12px]",weight:t.font.weight.bold,children:"Start Your Application"}),e.jsx(u,{bg:t.color.background.white,color:t.color.secondary,rounded:"8px",textSize:"text-[14px]",leading:"leading-[20px]",width:"206px",height:"44px",customPadding:"px-[22px] py-[12px]",borderColor:t.color.secondary,borderWidth:"1px",weight:t.font.weight.bold,children:"Contact Admissions"})]})]})]})]})}const C=({className:s=""})=>e.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M15.2734 12.7196L16.7684 21.1334C16.7852 21.2325 16.7713 21.3343 16.7286 21.4253C16.6859 21.5162 16.6165 21.592 16.5296 21.6424C16.4427 21.6929 16.3424 21.7156 16.2423 21.7075C16.1421 21.6994 16.0468 21.6609 15.9691 21.5972L12.4362 18.9456C12.2657 18.8182 12.0585 18.7493 11.8456 18.7493C11.6327 18.7493 11.4255 18.8182 11.255 18.9456L7.71615 21.5962C7.6385 21.6598 7.54331 21.6982 7.44328 21.7063C7.34325 21.7144 7.24313 21.6918 7.15627 21.6415C7.06942 21.5912 6.99997 21.5157 6.95718 21.4249C6.9144 21.3341 6.90031 21.2324 6.9168 21.1334L8.41088 12.7196",stroke:"white","stroke-width":"1.97368","stroke-linecap":"round","stroke-linejoin":"round"}),e.jsx("path",{d:"M11.8424 13.8154C15.1125 13.8154 17.7634 11.1644 17.7634 7.89432C17.7634 4.62421 15.1125 1.97327 11.8424 1.97327C8.57227 1.97327 5.92133 4.62421 5.92133 7.89432C5.92133 11.1644 8.57227 13.8154 11.8424 13.8154Z",stroke:"white","stroke-width":"1.97368","stroke-linecap":"round","stroke-linejoin":"round"})]}),ee=({className:s=""})=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:s,children:[e.jsx("path",{d:"M11.8423 1.97339V21.7102",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M16.7766 4.93384H9.37527C8.45923 4.93384 7.5807 5.29774 6.93296 5.94548C6.28522 6.59322 5.92133 7.47174 5.92133 8.38779C5.92133 9.30383 6.28522 10.1824 6.93296 10.8301C7.5807 11.4778 8.45923 11.8417 9.37527 11.8417H14.3095C15.2255 11.8417 16.1041 12.2056 16.7518 12.8534C17.3995 13.5011 17.7634 14.3796 17.7634 15.2957C17.7634 16.2117 17.3995 17.0902 16.7518 17.738C16.1041 18.3857 15.2255 18.7496 14.3095 18.7496H5.92133",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"})]}),te=({className:s=""})=>e.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M11.8417 21.7105C17.2919 21.7105 21.7101 17.2922 21.7101 11.8421C21.7101 6.39187 17.2919 1.97363 11.8417 1.97363C6.39151 1.97363 1.97327 6.39187 1.97327 11.8421C1.97327 17.2922 6.39151 21.7105 11.8417 21.7105Z",stroke:"#FFF","stroke-width":"1.97368","stroke-linecap":"round","stroke-linejoin":"round"}),e.jsx("path",{d:"M8.96985 8.88118C9.20186 8.22164 9.6598 7.66549 10.2626 7.31124C10.8653 6.95699 11.574 6.8275 12.2631 6.9457C12.9522 7.06389 13.5772 7.42216 14.0275 7.95703C14.4777 8.4919 14.7242 9.16886 14.7231 9.86802C14.7231 11.8417 11.7626 12.8285 11.7626 12.8285",stroke:"#FFF","stroke-width":"1.97368","stroke-linecap":"round","stroke-linejoin":"round"}),e.jsx("path",{d:"M11.8417 16.7761H11.8517",stroke:"#FFF","stroke-width":"1.97368","stroke-linecap":"round","stroke-linejoin":"round"})]}),se=[{value:"90%",label:"Students Receive Aid"},{value:"$12M+",label:"Annual Scholarships"},{value:"$15K",label:"Average Award"},{value:"100+",label:"Scholarship Programs"}];function re(){const s=[{title:"Check Eligibility",description:"Review the eligibility criteria for different scholarship and aid programs."},{title:"Gather Documents",description:"Prepare income certificates, caste certificates, mark sheets, and other required documents."},{title:"Submit Application",description:"Fill out the financial aid application form during or after the admission process."},{title:"Await Approval",description:"The committee will review your application and notify you of the decision."}];return e.jsx(x,{bg:t.bg.sectionCard,sectionClassName:"py-[60px] md:py-[80px]",children:e.jsxs("div",{className:"flex flex-col gap-[40px]",children:[e.jsx("h2",{className:`
          ...
          `,children:"Financial Aid & Scholarships"}),e.jsx("div",{className:`\r
            ...
            gap-[23.68px]\r
            w-full\r
          `,children:se.map((r,n)=>e.jsxs("div",{className:`\r
                bg-white\r
                h-[100.66px]\r
                rounded-[9.87px]\r
          ...
          `,children:[e.jsxs("div",{className:"bg-white rounded-[9.87px] p-[31.58px] flex flex-col gap-[16px]",style:{border:`1px solid ${t.color.border}`},children:[e.jsxs("div",{className:"flex items-center gap-[15.79px]",children:[e.jsx("div",{className:`\r
                ...
                `,style:{backgroundColor:t.color.primary},children:e.jsx(ee,{className:"w-[23.68px] h-[23.68px] text-white"})}),e.jsx("h3",{className:`
                  ${t.font.family}
                  ${t.font.weight.bold}
                  text-[23.68px]
                  leading-[33.16px]
              ...
              `,children:"Payment Options"}),e.jsx("ul",{className:"flex flex-col gap-[10px]",children:["Semester-wise fee payment structure","Installment options available","Online payment gateway for convenience","Fee refund policy as per university norms"].map((r,n)=>e.jsxs("li",{className:"flex items-start gap-[8px]",children:[e.jsx("span",{className:"w-[7.89px] h-[7.89px] rounded-full mt-[10px]",style:{backgroundColor:t.color.primary}}),e.jsx("span",{className:`${t.font.family} text-[15.79px] leading-[27.63px]`,style:{color:t.color.text.muted},children:r})]},n))})]}),e.jsxs("div",{className:"bg-white rounded-[9.87px] p-[31.58px] flex flex-col gap-[18px]",style:{border:`1px solid ${t.color.border}`},children:[e.jsxs("div",{className:"flex items-center gap-[15.79px]",children:[e.jsx("div",{className:`\r
                  ...
                  rounded-[9.87px]\r
                  flex items-center justify-center shrink-0\r
                `,style:{backgroundColor:t.color.primary},children:e.jsx(te,{className:"w-[23.68px] h-[23.68px]"})}),e.jsx("h3",{className:`
                  ${t.font.family}
                  ${t.font.weight.semibold}
                  text-[23.68px]
                  leading-[33.16px]
  ...
  `,style:{backgroundColor:"#EEF2F7",color:t.color.dark},children:n+1}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:`
          ...
          `,style:{backgroundColor:t.color.primary},children:s}),e.jsxs("div",{className:"flex flex-col gap-[8px]",children:[e.jsx("h3",{className:`
              ...
              leading-[33.16px]
              text-[${t.color.secondary}]
            `,children:r}),e.jsx("p",{className:`${t.font.family} text-[14px] leading-[20px] max-w-[420px]`,style:{color:"#6B7280"},children:n}),e.jsxs("div",{className:"flex gap-[8px] pt-[4px] items-start",children:[e.jsx($,{className:"w-[17.76px] h-[17.76px] shrink-0"}),e.jsxs("p",{className:`${t.font.family} text-[13.82px] leading-[19.74px]`,children:[e.jsx("span",{className:`${t.font.weight.semibold}`,style:{color:t.color.text.grayish},children:"Eligibility:"})," ",e.jsx("span",{style:{color:"#6B7280"},children:i})]})]})]})]})})}const ne=({className:s=""})=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:s,children:[e.jsx("path",{d:"M19.7367 9.86788C19.7367 14.7952 14.2706 19.9268 12.4351 21.5116C12.2641 21.6402 12.0559 21.7097 11.842 21.7097C11.6281 21.7097 11.4199 21.6402 11.2489 21.5116C9.41338 19.9268 3.94727 14.7952 3.94727 9.86788C3.94727 7.77407 4.77903 5.76601 6.25958 4.28546C7.74013 2.80491 9.74819 1.97314 11.842 1.97314C13.9358 1.97314 15.9439 2.80491 17.4244 4.28546C18.905 5.76601 19.7367 7.77407 19.7367 9.86788Z",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M11.8418 12.828C13.4768 12.828 14.8023 11.5026 14.8023 9.86751C14.8023 8.23246 13.4768 6.90698 11.8418 6.90698C10.2067 6.90698 8.88123 8.23246 8.88123 9.86751C8.88123 11.5026 10.2067 12.828 11.8418 12.828Z",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"})]}),ie=({className:s=""})=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",className:s,children:e.jsx("path",{d:"M13.6493 16.3495C13.8531 16.4431 14.0828 16.4644 14.3004 16.4101C14.5179 16.3557 14.7105 16.2289 14.8464 16.0504L15.1967 15.5916C15.3805 15.3464 15.6189 15.1475 15.893 15.0105C16.1671 14.8734 16.4692 14.8021 16.7757 14.8021H19.7362C20.2596 14.8021 20.7616 15.01 21.1318 15.3802C21.5019 15.7503 21.7099 16.2523 21.7099 16.7758V19.7363C21.7099 20.2598 21.5019 20.7618 21.1318 21.1319C20.7616 21.502 20.2596 21.71 19.7362 21.71C15.0251 21.71 10.507 19.8385 7.17573 16.5073C3.84449 13.176 1.97302 8.65791 1.97302 3.94683C1.97302 3.42338 2.18096 2.92136 2.5511 2.55122C2.92124 2.18109 3.42325 1.97314 3.94671 1.97314H6.90723C7.43069 1.97314 7.9327 2.18109 8.30284 2.55122C8.67298 2.92136 8.88092 3.42338 8.88092 3.94683V6.90736C8.88092 7.21376 8.80958 7.51596 8.67255 7.79001C8.53552 8.06407 8.33657 8.30246 8.09144 8.4863L7.6296 8.83268C7.44843 8.97102 7.32074 9.1678 7.26821 9.38961C7.21568 9.61142 7.24156 9.84457 7.34144 10.0495C8.69014 12.7888 10.9083 15.0042 13.6493 16.3495Z",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"})}),oe=({className:s=""})=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",className:s,children:[e.jsx("path",{d:"M21.7097 6.90698L12.837 12.5586C12.536 12.7335 12.194 12.8256 11.8458 12.8256C11.4976 12.8256 11.1556 12.7335 10.8545 12.5586L1.9729 6.90698",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M19.7361 3.94727H3.94658C2.85655 3.94727 1.9729 4.83091 1.9729 5.92095V17.7631C1.9729 18.8531 2.85655 19.7367 3.94658 19.7367H19.7361C20.8261 19.7367 21.7097 18.8531 21.7097 17.7631V5.92095C21.7097 4.83091 20.8261 3.94727 19.7361 3.94727Z",stroke:"currentColor",strokeWidth:"1.97368",strokeLinecap:"round",strokeLinejoin:"round"})]});function le(){return e.jsxs(x,{bg:t.bg.white,paddingClass:"py-[80px]",className:"flex flex-col gap-[40px]",children:[e.jsx("h2",{className:`
          ${t.font.family}
          ${t.font.weight.bold}
          text-[42px]
          leading-[52px]
          text-[${t.color.secondary}]
        `,children:"Join Our Nursing Community"}),e.jsxs("div",{className:"flex flex-wrap justify-center gap-[18px] mt-[40px]",children:[e.jsx(u,{customPadding:"px-[39px] py-[18px]",bg:t.color.primary,color:"white",rounded:"9.87px",textSize:"text-[15.79px]",leading:"leading-[23.68px]",height:"60px",icon:e.jsx(I,{size:19,stroke:"white",strokeWidth:1}),children:"Start Your Application"}),e.jsx(u,{customPadding:"px-[39.47px] py-[15.79px]",bg:"#EEF2F7",color:t.color.secondary,rounded:"9.87px",textSize:"text-[15.79px]",leading:"leading-[23.68px]",height:"59.21px",children:"Explore Programs"}),e.jsx(u,{customPadding:"px-[39.47px] py-[15.79px]",bg:"#EEF2F7",color:t.color.secondary,rounded:"9.87px",textSize:"text-[15.79px]",leading:"leading-[23.68px]",height:"59.21px",children:"Visit Website"})]}),e.jsxs("div",{className:`\r
          grid\r
          grid-cols-1\r
          sm:grid-cols-2\r
          lg:grid-cols-3\r
        ...
        `,children:[e.jsx(v,{icon:e.jsx(ne,{className:"w-[23.68px] h-[23.68px] text-white"}),title:"Visit Campus",subtitle1:"ASRAM Campus",subtitle2:"Eluru, Andhra Pradesh"}),e.jsx(v,{icon:e.jsx(ie,{className:"w-[23.68px] h-[23.68px] text-white"}),title:"Call Us",subtitle1:"Admissions Office",subtitle2:"Contact via asram.in"}),e.jsx(v,{icon:e.jsx(oe,{className:"w-[23.68px] h-[23.68px] text-white"}),title:"Email Us",subtitle1:"For admission inquiries",subtitle2:"See official website"})]}),e.jsx("div",{className:"w-full mt-[40px]",style:{border:"1px solid #19191933"}}),e.jsxs("div",{className:`\r
          grid\r
          grid-cols-4\r
          text-center\r
          gap-[24px]\r
      ...
      `,style:{backgroundColor:"#EEF2F7"},children:[e.jsxs("div",{className:`\r
        ...
        `,style:{backgroundColor:t.color.primary},children:[s,"      "]}),e.jsx("h3",{className:`
          ...
          leading-[29.61px]
          text-[${t.color.secondary}]
        `,children:r}),e.jsxs("p",{className:"text-[14px] leading-[20px] mt-[6px]",style:{color:"#191919BF"},children:[n,e.jsx("br",{}),i]})]})}function b({count:s,label:r}){const[n,i]=l.useState("0"),p=l.useRef(null),m=l.useRef(!1);l.useEffect(()=>{const d=p.current,o=new IntersectionObserver(a=>{a[0].isIntersecting&&!m.current&&(m.current=!0,f())},{threshold:.4});return d&&o.observe(d),()=>o.disconnect()},[]);const f=()=>{const d=parseInt(s.replace(/\D/g,""),10),o=s.replace(/[0-9]/g,"");if(isNaN(d)){i(s);return}const a=1200,h=performance.now(),g=j=>{const y=Math.min((j-h)/a,1),w=Math.floor(y*d);i(w+o),y<1&&requestAnimationFrame(g)};requestAnimationFrame(g)};return e.jsxs("div",{className:"flex flex-col items-center text-center",ref:p,children:[e.jsx("span",{className:`
          ${t.font.family}
          ${t.font.weight.bold}
          text-[35.53px]
          leading-[39.47px]
        ...
        `,children:n}),e.jsx("span",{className:`
          ...
          leading-[23.68px]
          font-regular
        `,style:{color:"#191919BF"},children:r})]})}const ae="/AsramWebsite-FE/assets/asramacademicsbanner-Rp9-HRkA.png",ye=()=>{const{setHero:s,hideHero:r}=S();return l.useLayoutEffect(()=>(s({title:e.jsx(B,{text:"Build a Career in Healthcare",className:"font-montserrat font-bold text-[32px] md:text-[40px] leading-[1.2] text-white"}),bgImage:ae,children:e.jsx(e.Fragment,{children:e.jsx("p",{className:"font-montserrat font-medium text-[16px] md:text-[22px] leading-[1.4] text-white max-w-[520px] mb-6",children:"Structured medical education supported by experienced faculty, advanced laboratories, and real-world clinical exposure."})})}),()=>r()),[s,r]),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:e.jsx(V,{})}),e.jsx(c,{delay:.1,children:e.jsx(T,{})}),e.jsx(c,{delay:.1,children:e.jsx(L,{})}),e.jsx(c,{delay:.2,children:e.jsx(q,{})}),e.jsx(c,{delay:.2,children:e.jsx(X,{})}),e.jsx(c,{delay:.3,children:e.jsx(H,{})}),e.jsx(c,{delay:.3,children:e.jsx(re,{})}),e.jsx(c,{delay:.4,children:e.jsx(le,{})})]})};export{ye as default};
