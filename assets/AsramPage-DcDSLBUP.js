import{j as e,u as h,a as g,m as u}from"./animations-Ddm3AZVI.js";import{L as j,r as d}from"./vendor-CEFHwVPC.js";import{C as x}from"./ContentImageSection-3crbRdZ3.js";import{P as o,T as s,u as C}from"./index-C6Seta4K.js";import{I as k}from"./InfoCardGrid-BQ1KkaJp.js";import{B as f}from"./button-P7XFFMMG.js";import{A as w}from"./AsramNewsEvents-DLzbUNxE.js";import{A as c}from"./AnimatedStatValue-D_cgLpr-.js";import{T as l}from"./TypedText-DcocL7jk.js";const b="/AsramWebsite-FE/assets/asram/reputationbuilt.png",F=()=>e.jsx(x,{title:"A Reputation Built on Quality",description:"ASRAM School of Nursing is widely respected for its high-quality teaching, strong clinical training, and excellent student outcomes. Our programs continue to earn strong recognition for academic standards and hands-on learning.",description2:"ASRAM School of Nursing is widely respected for its high-quality teaching, strong clinical training, and excellent student outcomes.",image:b,buttonText:"Explore Our Achievements",buttonLink:"#",showButton:!0,reverse:!0}),v=({size:t=22,stroke:r="#191919",strokeWidth:n=2,className:i=""})=>e.jsxs("svg",{width:t,height:t,viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",className:i,children:[e.jsx("path",{d:"M2.75 11H18.7917",stroke:r,strokeWidth:n,strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M12.8333 4.58342L19.2499 11.0001L12.8333 17.4167",stroke:r,strokeWidth:n,strokeLinecap:"round",strokeLinejoin:"round"})]}),y="/AsramWebsite-FE/assets/icons/MedicalIcon.svg",N="/AsramWebsite-FE/assets/icons/HeartCareIcon.svg",A="/AsramWebsite-FE/assets/icons/IconParamedical.svg",M=[{id:1,icon:y,name:"ASRAM Medical College",tagline:"Shaping Future Doctors",description:"Recognized medical college with strong academics, clinical training, and research.",cta:"Visit Medical College"},{id:2,icon:N,name:"ASRAM College of Nursing",tagline:"Precision-Driven Cancer Care",description:"B.Sc Nursing & GNM programs with hands-on skill labs and hospital training.",cta:"Visit Nursing College Website"},{id:3,icon:A,name:"ASRAM Paramedical Institute",tagline:"Technical Excellence in Healthcare",description:"Professional programs in allied health sciences supporting modern medical systems.",cta:"Visit Paramedical Website"}],L={1:"#C0392B",2:"#008C8C",3:"#A66E00"},H={1:"rgba(192,57,43,0.10)",2:"rgba(0,140,140,0.10)",3:"rgba(166,110,0,0.10)"},E={1:"#C0392B1A",2:"#008C8C1A",3:"#A66E001A"},S=()=>e.jsxs(o,{bg:"bg-[#EEF2F7]",paddingClass:"py-[40px] md:py-[60px] lg:py-[80px]",children:[e.jsx("div",{className:"absolute top-[-60px] lg:top-[-90px] right-8 lg:right-[92px] opacity-30 select-none pointer-events-none"}),e.jsxs("div",{className:"w-full",children:[e.jsx("h2",{className:`
            ${s.font.weight.bold} 
            text-[#223F7F]
          ...
          `,children:M.map(t=>e.jsx("div",{className:`\r
              ...
              `,children:e.jsxs("div",{className:"flex flex-col gap-[26px] h-full",children:[e.jsx("div",{className:`\r
                ...
                `,style:{backgroundColor:H[t.id]},children:e.jsx("img",{src:t.icon,className:"w-[32px] h-[32px]",alt:""})}),e.jsx("div",{className:"flex items-start",children:e.jsxs("h6",{className:`
                  ...
                  `,children:t.description})}),e.jsxs(j,{to:t.id===1?"/medical":t.id===2?"/nursing":"#",className:`\r
                  mt-auto\r
                  w-full\r
                  h-[46px]\r
                  rounded-[6px]\r
          ...
          `,children:"Clinical Exposure & Hospital Access"}),e.jsxs("div",{className:"flex flex-col lg:flex-row gap-[40px] items-stretch",children:[e.jsx("div",{className:"flex-1 flex flex-col justify-start gap-[20px]",children:t.map((n,i)=>e.jsxs("div",{className:"flex gap-[20px] items-start",children:[e.jsx("div",{className:`\r
              ...
              `,children:n.icon}),e.jsxs("div",{className:"flex flex-col gap-[4px]",children:[e.jsx("h3",{className:`
                ...
                `,children:n.title}),e.jsx("p",{className:`
                  ...
                  leading-[1.5]
                  text-[#191919BF]
                `,children:n.description})]})]},i))}),e.jsx("div",{className:"w-full lg:w-[580px] flex-shrink-0",children:e.jsx("img",{src:ee,alt:"Clinical Exposure",className:"w-full h-full min-h-[300px] lg:min-h-[355px] object-cover rounded-[12px] shadow-sm"})})]}),e.jsx("div",{style:{border:"solid 1px rgba(7, 7, 7, 0.2)"},className:"bg-[#FFF] rounded-[12px] p-[20px]   mt-[60px]",children:e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-[30px] items-center text-center",children:r.map((n,i)=>e.jsxs("div",{className:"flex flex-col items-center justify-center",children:[e.jsx(c,{value:n.value,className:`
      font-montserrat
        font-semibold
        text-[32px]
        mb-[10px]
        leading-[39px]
        text-[#223F7F]
      `}),e.jsx("p",{className:`${s.font.family} text-[18px] text-[#191919BF] font-regular leading-[26px]`,children:n.label})]},i))})})]})},se="/AsramWebsite-FE/assets/asram/insideasram.png",ne="/AsramWebsite-FE/assets/asram/researchinnov.png",re="/AsramWebsite-FE/assets/asram/asramherobanner.png",he=()=>{const{setHero:t,hideHero:r}=C();return d.useLayoutEffect(()=>(t({title:e.jsxs(e.Fragment,{children:[e.jsx(l,{text:"DISCOVER",className:"font-regular"})," ",e.jsx(l,{text:"ASRAM",className:"font-bold",delay:.5})]}),bgImage:re,children:e.jsxs(e.Fragment,{children:[e.jsx("p",{className:`\r
        ...
        `,image:ne}),e.jsx(te,{}),e.jsx(X,{})]})};export{he as A};
