import{j as e}from"./animations-DcqeVXJS.js";import"./vendor-x-yVq9gV.js";import{T as s,P as t}from"./index-DJznWsAu.js";const n="/AsramWebsite-FE/assets/icons/IconLeftQuote.svg",i=[{text:"ASRAM has given me not just excellent medical education, but also lifelong friendships and experiences that have shaped who I am today.",name:"Priya Sharma",program:"MBBS, 3rd Year"},{text:"The campus culture is incredible. From sports to cultural events, there's always something happening. The faculty support is outstanding.",name:"Rahul Verma",program:"B.Sc. Nursing, Final Year"},{text:"Living in the hostel has been amazing. The facilities are great, and I've learned so much from my peers. It truly feels like home.",name:"Anjali Patel",program:"Paramedical, 2nd Year"}];function m({theme:a}){const r=a?.secondary||s.color.secondary;return e.jsx(t,{bg:s.bg.white,sectionClassName:"py-[80px]",children:e.jsxs("div",{className:"flex flex-col gap-[40px]",children:[e.jsx("h2",{className:`
            ${s.font.family}
            ${s.font.weight.bold}
            text-[42px]
            leading-[42px]
