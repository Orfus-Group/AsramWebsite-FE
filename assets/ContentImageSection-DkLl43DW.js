import{j as e}from"./animations-D3tOYQY4.js";import{L as c}from"./vendor-CEFHwVPC.js";import{P as f}from"./index-DQtDRjeY.js";const u=({title:t,description:s,description2:x,image:a,buttonText:l,buttonLink:r="#",showButton:p=!1,reverse:n=!1,imageClassName:d="",className:o="",bg:i="bg-white",gapClass:m="gap-[30px] md:gap-[50px] lg:gap-[72px]"})=>e.jsx(f,{bg:i,paddingClass:"py-[40px] md:py-[60px] lg:py-[80px]",children:e.jsxs("div",{className:`
          w-full
          flex
          flex-col-reverse
        ...
        `,children:[e.jsxs("div",{className:"w-full flex-1 flex flex-col h-full items-start gap-[20px]",children:[e.jsx("h2",{className:`
            ...
            `,children:t}),e.jsxs("div",{className:"flex flex-col gap-[20px]",children:[e.jsx("p",{className:`
              ...
              `,children:s}),x&&e.jsx("p",{className:`
                  ...
                  text-justify
                  font-montserrat
                `,children:x})]}),p&&l&&e.jsx(c,{to:r,className:`
                w-full
                sm:w-[260px]
                md:w-[301px]
                h-[46px]
