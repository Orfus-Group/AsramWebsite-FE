import{j as e}from"./animations-DcqeVXJS.js";import{L as f}from"./vendor-x-yVq9gV.js";import{P as g}from"./index-DChSeORM.js";const w=({title:t,description:s,description2:x,image:a,buttonText:l,buttonLink:r="#",showButton:p=!1,reverse:n=!1,imageClassName:d="",className:o="",bg:i="bg-white",gapClass:m="gap-[30px] md:gap-[50px] lg:gap-[72px]",paddingClass:c="py-[40px] md:py-[60px] lg:py-[80px]"})=>e.jsx(g,{bg:i,paddingClass:c,children:e.jsxs("div",{className:`
          w-full
          flex
          flex-col-reverse
