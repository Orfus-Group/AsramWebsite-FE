import{j as e}from"./animations-D3tOYQY4.js";import{r as l}from"./vendor-CEFHwVPC.js";import{P as x,T as t,u as F}from"./index-DQtDRjeY.js";import{I as A}from"./IconFullArrow-l6J0f89Q.js";import{b as M,W as L}from"./CheckMarkIcon-BLe-OG_V.js";import{B as f}from"./button-D0L89uCr.js";import{S as H}from"./StudentVoices-D5E6ACwU.js";import{I as B}from"./IconArrowRight-C_dN895v.js";import{M as c}from"./MotionSection-BH0xkWDy.js";const I="data:image/svg+xml,%3csvg%20width='18'%20height='18'%20viewBox='0%200%2018%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M8.88135%204.44043V8.88122L11.8419%2010.3615'%20stroke='%23191919'%20stroke-opacity='0.75'%20stroke-width='1.48026'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.8813%2016.2831C12.9689%2016.2831%2016.2826%2012.9694%2016.2826%208.88178C16.2826%204.79415%2012.9689%201.48047%208.8813%201.48047C4.79366%201.48047%201.47998%204.79415%201.47998%208.88178C1.47998%2012.9694%204.79366%2016.2831%208.8813%2016.2831Z'%20stroke='%23191919'%20stroke-opacity='0.75'%20stroke-width='1.48026'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",P=[{tag:"Undergraduate",title:"B.Sc Nursing",years:"4 Years",seats:"100 Seats",description:"Comprehensive undergraduate program combining theoretical knowledge with extensive clinical practice. Perfect for students seeking a professional nursing career.",highlights:["Clinical rotations in multispeciality hospital","Research opportunities","International nursing standards"]},{tag:"Diploma",title:"General Nursing & Midwifery",years:"3 Years",seats:"60 Seats",description:"Intensive diploma program focused on nursing fundamentals and midwifery. Ideal for those wanting to enter the nursing profession quickly.",highlights:["Hands-on clinical training","Obstetrics & gynecological focus","Community health experience"]},{tag:"Postgraduate",title:"M.Sc Nursing",years:"2 Years",seats:"30 Seats",description:"Advanced nursing education with specializations in Medical-Surgical, Obstetrics, Pediatrics, Community Health, and Psychiatric Nursing.",highlights:["Research & thesis work","Leadership development","Academic & clinical roles"]}];function E(){return e.jsxs(x,{bg:t.bg.white,paddingClass:"py-[80px]",children:[e.jsx("h2",{className:`
  ...
  `,style:{backgroundColor:"#EEF2F7",color:t.color.dark},children:n+1}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:`
          ...
          leading-[52px]
          text-[${t.color.secondary}]
        `,children:"Join Our Nursing Community"}),e.jsxs("div",{className:"flex flex-wrap justify-center gap-[18px] mt-[40px]",children:[e.jsx(f,{customPadding:"px-[39px] py-[18px]",bg:t.color.primary,color:"white",rounded:"9.87px",textSize:"text-[15.79px]",leading:"leading-[23.68px]",height:"60px",icon:e.jsx(B,{size:19,stroke:"white",strokeWidth:1}),children:"Start Your Application"}),e.jsx(f,{customPadding:"px-[39.47px] py-[15.79px]",bg:"#EEF2F7",color:t.color.secondary,rounded:"9.87px",textSize:"text-[15.79px]",leading:"leading-[23.68px]",height:"59.21px",children:"Explore Programs"}),e.jsx(f,{customPadding:"px-[39.47px] py-[15.79px]",bg:"#EEF2F7",color:t.color.secondary,rounded:"9.87px",textSize:"text-[15.79px]",leading:"leading-[23.68px]",height:"59.21px",children:"Visit Website"})]}),e.jsxs("div",{className:`\r
          grid\r
          grid-cols-1\r
          sm:grid-cols-2\r
          lg:grid-cols-3\r
      ...
      `,style:{backgroundColor:"#EEF2F7"},children:[e.jsxs("div",{className:`\r
        ...
        `,style:{backgroundColor:t.color.primary},children:[s,"      "]}),e.jsx("h3",{className:`
          ...
          leading-[29.61px]
          text-[${t.color.secondary}]
        `,children:r}),e.jsxs("p",{className:"text-[14px] leading-[20px] mt-[6px]",style:{color:"#191919BF"},children:[n,e.jsx("br",{}),i]})]})}function b({count:s,label:r}){const[n,i]=l.useState("0"),p=l.useRef(null),m=l.useRef(!1);l.useEffect(()=>{const d=p.current,o=new IntersectionObserver(a=>{a[0].isIntersecting&&!m.current&&(m.current=!0,g())},{threshold:.4});return d&&o.observe(d),()=>o.disconnect()},[]);const g=()=>{const d=parseInt(s.replace(/\D/g,""),10),o=s.replace(/[0-9]/g,"");if(isNaN(d)){i(s);return}const a=1200,h=performance.now(),u=j=>{const y=Math.min((j-h)/a,1),w=Math.floor(y*d);i(w+o),y<1&&requestAnimationFrame(u)};requestAnimationFrame(u)};return e.jsxs("div",{className:"flex flex-col items-center text-center",ref:p,children:[e.jsx("span",{className:`
          ${t.font.family}
          ${t.font.weight.bold}
          text-[35.53px]
          leading-[39.47px]
