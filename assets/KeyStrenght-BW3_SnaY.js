import{j as t}from"./animations-DcqeVXJS.js";import"./vendor-x-yVq9gV.js";import{T as e,P as g}from"./index-DChSeORM.js";import{I as h}from"./SocialCommitment-GfSl25Ao.js";const u="/AsramWebsite-FE/assets/icons/CheckMarkIcon.svg",f=t.jsx("img",{src:u,className:"w-[14px] h-[14px] shrink-0",alt:""});function b({title:r="Why Choose ASRAM Nursing?",columns:o,CheckIcon:n}){const s=o||[{title:"Educational Excellence",items:["Integration with comprehensive multispecialty hospital","Robust infrastructure across the 10-acre campus","Recognized affiliations and regulatory approvals"]},{title:"Student Success",items:["Clear pathways from undergraduate to postgraduate","Student-centered environment with strong mentoring","Practical orientation ensuring job readiness"]}],l=n||f;return t.jsx("div",{className:"w-full mt-[50px] mb-[80px]",children:t.jsx("div",{className:"w-full flex flex-col items-center",children:t.jsxs("div",{className:`\r
            w-full\r
            rounded-[10px]\r
