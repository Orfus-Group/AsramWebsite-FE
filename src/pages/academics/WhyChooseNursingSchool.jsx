...
export const HolisticDevIcon = ({ className = "" }) => (
  <svg {...baseProps} className={className}>
    <path
      d="M12.6839 3.23998C12.7332 2.97587 12.8733 2.73733 13.08 2.56567C13.2867 2.39401 13.5469 2.30005 13.8156 2.30005C14.0843 2.30005 14.3445 2.39401 14.5512 2.56567C14.7579 2.73733 14.898 2.97587 14.9473 3.23998L16.1574 9.63899C16.2433 10.0939 16.4644 10.5124 16.7918 10.8398C17.1192 11.1672 17.5376 11.3882 17.9926 11.4742L24.3916 12.6842C24.6557 12.7336 24.8942 12.8737 25.0659 13.0804C25.2375 13.2871 25.3315 13.5473 25.3315 13.816C25.3315 14.0846 25.2375 14.3449 25.0659 14.5515C24.8942 14.7582 24.6557 14.8984 24.3916 14.9477L17.9926 16.1577C17.5376 16.2437 17.1192 16.4648 16.7918 16.7921C16.4644 17.1195 16.2433 17.538 16.1574 17.9929L14.9473 24.392C14.898 24.6561 14.7579 24.8946 14.5512 25.0663C14.3445 25.2379 14.0843 25.3319 13.8156 25.3319C13.5469 25.3319 13.2867 25.2379 13.08 25.0663C12.8733 24.8946 12.7332 24.6561 12.6839 24.392L11.4738 17.9929C11.3879 17.538 11.1668 17.1195 10.8394 16.7921C10.512 16.4648 10.0936 16.2437 9.63862 16.1577L3.23961 14.9477C2.9755 14.8984 2.73696 14.7582 2.56531 14.5515C2.39365 14.3449 2.29968 14.0846 2.29968 13.816C2.29968 13.5473 2.39365 13.2871 2.56531 13.0804C2.73696 12.8737 2.9755 12.7336 3.23961 12.6842L9.63862 11.4742C10.0936 11.3882 10.512 11.1672 10.8394 10.8398C11.1668 10.5124 11.3879 10.0939 11.4738 9.63899L12.6839 3.23998Z"
      stroke="white"
      strokeWidth="2.30263"
      strokeLinecap="round"
      strokeLinejoin="round"
