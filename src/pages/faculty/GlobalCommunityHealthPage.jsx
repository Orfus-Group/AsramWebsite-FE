...
const IconMobileHealth = (props) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

const IconSchoolHealth = (props) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
// Updated IconResearch to Stethoscope
const IconStethoscope = (props) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M6 3v12a6 6 0 0 0 12 0V3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M6 3 H3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M21 3 h-3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 15v3a2 2 0 0 0 2 2h4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="20" cy="20" r="2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
// Formerly IconResearch - kept for compatibility if needed elsewhere but not used here
        ...
        <div className="bg-white min-h-screen">
            ...
            <PageSection paddingClass="py-[60px] md:py-[80px]">
                <div className="max-w-4xl">
                    <h3 className={`${T.font.family} font-bold text-[32px] text-[#223F7F] mb-6`}>Overview</h3>
                    <div className="space-y-6 text-[#191919BF] text-[18px] leading-[26px] font-regular">
                        <p>
                        ...
                        <p>
                            Through a combination of grassroots community engagement and high-level international partnerships, we foster a culture of service, learning, and innovation. Our programs provide vital care to those in need while training the next generation of healthcare leaders to think globally and act locally.
                        </p>
                    </div>
                </div>
            </PageSection>
            ...
            <PageSection bg="bg-[#F9FAFB]" paddingClass="py-[60px] md:py-[80px]">
                <div className="mb-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_145_1293">
                                            <rect width="20.6911" height="20.6911" fill="white" />
                                        </clipPath>
                                    </defs>
                                </svg>
                            </div>
                            <h3 className={`${T.font.family} font-semibold text-[17px] text-[#223F7F] mb-3`}>Rural Health Centers</h3>
                            <p className="text-[#4A5565] font-regular text-[13px] leading-[22px]">
                                Providing essential primary care services to underserved village populations through our network of rural satellite clinics.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-[14.14px] border-[0.86px] border-t-[3.45px] border-[#E5E5E5] p-8 shadow-sm hover:shadow-md transition-all duration-300">
                            ...
                            <h3 className={`${T.font.family} font-semibold text-[17px] text-[#223F7F] mb-3`}>Mobile Medical Units</h3>
                            <p className="text-[#4A5565] font-regular text-[13px] leading-[22px]">
                                Equipped with diagnostic facilities and medical staff, our mobile units reach remote areas to deliver healthcare at the doorstep.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-[14.14px] border-[0.86px] border-t-[3.45px] border-[#E5E5E5] p-8 shadow-sm hover:shadow-md transition-all duration-300">
                            ...
                            <h3 className={`${T.font.family} font-semibold text-[17px] text-[#223F7F] mb-3`}>School Health Program</h3>
                            <p className="text-[#4A5565] font-regular text-[13px] leading-[22px]">
                                Regular health screenings, vaccination drives, and hygiene education for children in local government schools.
                            </p>
                        </div>
            ...
            <PageSection paddingClass="py-[60px] lg:py-[120px] px-6 lg:pl-[120px] lg:pr-[40px]">
                <div className="mb-0">
                    <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-[80px]">
                        {/* Content Side */}
                        <div className="flex-1 lg:max-w-[630.82px] relative z-10 w-full">
                            <h2 className={`${T.font.family} font-bold text-[33px] text-[#223F7F] mb-8 lg:mb-[60px]`}>Global Health Initiatives</h2>
                        ...
                        {/* Image Side */}
                        <div className="relative w-full lg:w-[630.82px] h-[300px] lg:h-[469.36px]">
                            <img
                                src={Globalhealthimg}
                                alt="International Vaccination Certificate"
                                className="w-full h-full object-cover rounded-[15.02px] shadow-lg"
                            />
                        </div>
                    </div>
                </div>
            ...
            <PageSection>
                ...
                <div className="pb-20 lg:pb-[120px] pt-[60px]">
                    <h2 className={`${T.font.family} font-bold text-[30.6px] text-[#223F7F] mb-10 text-center md:text-left`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col">
                            ...
                            <h3 className="text-[17px] font-semibold text-[#223F7F] my-[20px]">Dr. Rajesh Kumar</h3>
                            <p className="text-[#008C8C] text-[13.6px] font-medium">Director, Global Health</p>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <h3 className="text-[17px] font-semibold text-[#223F7F] my-[20px]">Dr. Sarah Smith</h3>
                            <p className="text-[#008C8C] text-[13.6px] font-medium">Coordinator, Community Outreach</p>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <h3 className="text-[17px] font-semibold text-[#223F7F] my-[20px]">Mr. Amit Patel</h3>
                            <p className="text-[#008C8C] text-[13.6px] font-medium">Program Manager</p>
                        </div>
...
export default GlobalCommunityHealthPage;
