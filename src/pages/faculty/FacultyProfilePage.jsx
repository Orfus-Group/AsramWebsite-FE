...
const IconFile = (props) => (
    <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5.63184 20.6534C5.13391 20.6534 4.65637 20.4556 4.30429 20.1035C3.9522 19.7514 3.75439 19.2738 3.75439 18.7759V3.75635C3.75439 3.25842 3.9522 2.78089 4.30429 2.4288C4.65637 2.07671 5.13391 1.87891 5.63184 1.87891H13.1416C13.4388 1.87843 13.7331 1.93674 14.0076 2.05048C14.2821 2.16422 14.5315 2.33115 14.7412 2.54165L18.1093 5.90978C18.3204 6.11959 18.4878 6.36914 18.6019 6.64402C18.7159 6.91889 18.7744 7.21364 18.774 7.51124V18.7759C18.774 19.2738 18.5761 19.7514 18.2241 20.1035C17.872 20.4556 17.3944 20.6534 16.8965 20.6534H5.63184Z" stroke="#223F7F" stroke-width="1.87744" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M13.1416 1.87891V6.57252C13.1416 6.82148 13.2405 7.06025 13.4165 7.23629C13.5926 7.41234 13.8314 7.51124 14.0803 7.51124H18.7739" stroke="#223F7F" stroke-width="1.87744" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M9.38672 8.44922H7.50928" stroke="#223F7F" stroke-width="1.87744" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M15.0191 12.2031H7.50928" stroke="#223F7F" stroke-width="1.87744" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M15.0191 15.957H7.50928" stroke="#223F7F" stroke-width="1.87744" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-3 w-full max-w-2xl py-[32px]">
                                    ...
                                    <div className="flex items-start gap-3 text-[#4a5565]">
                                        <div className=" text-[#008C8C]"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.1081 10.082L13.2932 16.7517C13.3065 16.8302 13.2955 16.9109 13.2616 16.983C13.2278 17.0551 13.1728 17.1152 13.1039 17.1551C13.035 17.1951 12.9555 17.2131 12.8761 17.2067C12.7967 17.2003 12.7212 17.1698 12.6596 17.1193L9.85906 15.0174C9.72387 14.9164 9.55963 14.8618 9.39087 14.8618C9.22212 14.8618 9.05788 14.9164 8.92269 15.0174L6.11747 17.1185C6.05592 17.1689 5.98047 17.1994 5.90117 17.2058C5.82187 17.2122 5.74251 17.1943 5.67366 17.1544C5.60481 17.1146 5.54976 17.0546 5.51584 16.9827C5.48193 16.9107 5.47076 16.8301 5.48383 16.7517L6.66819 10.082" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9.38746 10.9497C11.9797 10.9497 14.0811 8.84832 14.0811 6.25611C14.0811 3.6639 11.9797 1.5625 9.38746 1.5625C6.79525 1.5625 4.69385 3.6639 4.69385 6.25611C4.69385 8.84832 6.79525 10.9497 9.38746 10.9497Z" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    ...
                                    <div className="flex items-start gap-3 text-[#4a5565]">
                                        <div className=" text-[#008C8C]"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.25708 1.5625V4.69157" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.5164 1.5625V4.69157" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M14.8627 3.12891H3.91097C3.0469 3.12891 2.34644 3.82937 2.34644 4.69344V15.6452C2.34644 16.5093 3.0469 17.2097 3.91097 17.2097H14.8627C15.7268 17.2097 16.4273 16.5093 16.4273 15.6452V4.69344C16.4273 3.82937 15.7268 3.12891 14.8627 3.12891Z" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.34644 7.82422H16.4273" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    ...
                                    <div className="flex items-start gap-3 text-[#4a5565]">
                                        <div className=" text-[#008C8C]"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.6462 7.82065C15.6462 11.7265 11.3132 15.7943 9.85817 17.0506C9.72263 17.1526 9.55763 17.2077 9.38803 17.2077C9.21844 17.2077 9.05344 17.1526 8.91789 17.0506C7.46287 15.7943 3.12988 11.7265 3.12988 7.82065C3.12988 6.16088 3.78922 4.5691 4.96285 3.39547C6.13648 2.22184 7.72827 1.5625 9.38803 1.5625C11.0478 1.5625 12.6396 2.22184 13.8132 3.39547C14.9868 4.5691 15.6462 6.16088 15.6462 7.82065Z" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9.38758 10.1702C10.6837 10.1702 11.7344 9.11947 11.7344 7.82337C11.7344 6.52726 10.6837 5.47656 9.38758 5.47656C8.09147 5.47656 7.04077 6.52726 7.04077 7.82337C7.04077 9.11947 8.09147 10.1702 9.38758 10.1702Z" stroke="#223F7F" stroke-width="1.56454" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                        ...
                        <SectionCard title="Research Interests">
                            <div className="flex flex-wrap gap-3">
                                {["Acute Coronary Syndrome Management", "Cardiac Imaging and Diagnostics", "Preventive Cardiology", "Heart Failure Management", "Cardiac Rehabilitation"].map((tag, i) => (
                                    <span key={i} className="bg-[#EEF2F7] text-[#191919BF] px-4 py-2 rounded-[9.4px] text-[15px] font-regular border border-[#07070733]">
                                        {tag}
                                    </span>
                                ))}
                            </div>
                                    ...
                                    <div key={idx} className="flex gap-4 p-4 border border-gray-100 rounded-[8px] hover:border-gray-300 transition-colors cursor-pointer bg-gray-50/50">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 text-[14px] font-regular text-[#191919BF]">
                                                ...
                                                <span>{pub.year}</span>
                                                <span>•</span>
                                                <span className="bg-[#EEF2F7] font-regular text-[12px] px-2 py-0.5 rounded-[3.8px] text-[#191919BF]">{pub.type}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={i} className="flex items-start gap-3 text-[#4B5563]">
                                        <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#223F7F] shrink-0" />
                            ...
                            <ul className="space-y-2">
                                {[
                                    ...
                                    <li key={i} className="flex gap-2 font-regular text-[13px] text-[#364153]">
                                        <span className="text-[#008C8C] mt-1.5 w-1.5 h-1.5 rounded-[31498264px] bg-[#223F7F] shrink-0" />
                                        <span>{mem}</span>
                                    </li>
                                ))}
                            </ul>
