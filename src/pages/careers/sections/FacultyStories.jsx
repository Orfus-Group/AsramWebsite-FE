            ...
            <div className="w-full max-w-[1440px] mx-auto px-5 sm:px-6 md:px-10 lg:px-[120px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px]">
                    {stories.map((story, index) => (
                        <div key={index} className="bg-[#eef2f7] p-[20px] md:p-[30px] rounded-[7.5px] h-full md:min-h-[336px] flex flex-col justify-start">
                            ...
                            <p className="text-[16px] md:text-[18px] leading-[1.44] text-[#191919] opacity-75 text-left">
                                {story.text}
                            </p>
                        </div>
                    ))}
