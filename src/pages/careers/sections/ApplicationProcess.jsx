...
const ApplicationProcess = () => {
    return (
        <section className="bg-[#eef2f7] w-full font-montserrat" style={{ padding: "80px 0" }}>
            <div className="w-full max-w-[1440px] mx-auto px-5 sm:px-6 md:px-10 lg:px-[120px]">
                <div className="bg-white p-[40px] rounded-[12px] flex flex-col gap-[20px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[20px]">
                        {steps.map((step) => (
                            <div key={step.step} className="bg-white p-[20px] rounded-[10px] border-[0.9px] border-[rgba(7,7,7,0.2)] min-h-[216.1px] h-full flex flex-col items-center justify-start text-center">
                                <div className="w-[60.1px] h-[60.1px] rounded-full bg-[#223F7F] text-white text-[24px] font-bold flex items-center justify-center mb-[12px] flex-shrink-0">
                                    {step.step}
                                </div>
                                <h3 className="text-[20px] font-bold text-[#191919] mb-[12px] leading-[1.2]">
                                    {step.title}
                                </h3>
