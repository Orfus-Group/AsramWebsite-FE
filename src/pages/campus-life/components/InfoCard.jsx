    ...
    if (variant === "vertical-white") {
        return (
            <div
                ...
                className={`bg-white p-[30px] rounded-[12px] flex flex-col items-start shadow-sm border border-gray-100 ${className}`}
            >
                <div className="bg-[#223F7F]/10 p-2.5 rounded-[8px] mb-4 flex items-center justify-center">
                    {icon}
                </div>
