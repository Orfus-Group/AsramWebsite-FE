...
import { T } from "@/theme";
import { HiOutlineMusicNote, HiOutlineCamera, HiOutlineColorSwatch, HiOutlineCode, HiOutlineGlobe, HiOutlineUsers } from "react-icons/hi";
...
}} key={index} className="bg-[#EEF2F7] p-[30px] rounded-[12px] flex flex-col items-start border border-transparent hover:border-[#223F7F20] transition-colors">
                        <div className="bg-white p-2.5 rounded-[8px] mb-4">
                            {item.icon}
                        </div>
                        <h6 className={`${T.font.family} font-semibold text-[22px] text-[#223F7F] mb-3`}>
                            {item.title}
                        </h6>
                        <p className={`${T.font.family} text-[18px] text-[#4B5563] font-regular leading-[26px]`}>
                            {item.description}
                        </p>
                    </div>
                ))}
