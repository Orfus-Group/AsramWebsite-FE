...
const SignupPage = () => {
    ...
    return (
        <div
            className="w-full min-h-screen flex justify-center bg-cover bg-center bg-no-repeat"
            style={{ backgroundImage: "url(/AsramWebsite-FE/assets/login/loginbg.png)" }}
        >
            <div className="w-full max-w-[1440px] flex flex-col items-center justify-start py-10 px-4 md:px-8 lg:px-[60px] xl:py-[80px] xl:px-[120px]">
                <img
                ...
                <div className="w-full max-w-[1200px] flex flex-col xl:flex-row items-center xl:items-start xl:justify-between gap-8 xl:gap-[60px] min-[1440px]:gap-[139px]">

                    {/* Left Section: Portal Selection */}
                    <div className="w-full max-w-[500px] xl:max-w-none xl:w-[500px] min-[1440px]:w-[592px] shrink-0 flex flex-col gap-[20px]">
                        <div className="flex flex-col gap-[8px]">
                            <h3 className="text-[24px] lg:text-[28px] xl:text-[32px] font-bold text-[#223F7F] font-montserrat leading-none">
                                Select Your Portal
                            </h3>
                            <p className="text-[#4A5565] text-[16px] xl:text-[18px] font-medium font-montserrat leading-none">
