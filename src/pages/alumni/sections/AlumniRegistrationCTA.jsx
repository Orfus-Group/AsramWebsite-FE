...
const AlumniRegistrationCTA = () => {
    return (
        <section className="py-[80px] bg-white w-full font-montserrat border-t border-gray-100 flex flex-col items-center">
            <div className="w-full max-w-[1440px] px-[120px] flex flex-col items-center gap-[22.5px]">
                <h2 className="text-[32px] font-semibold text-[#191919] text-center leading-tight">
                    Register with ASRAM Alumni Association
                </h2>
                <p className="text-[18px] text-[#6b6b6b] text-center leading-[1.44] font-normal max-w-[685px]">
                ...
                <button className="bg-[#223F7F] text-white px-[24px] py-[12px] rounded-[7.5px] font-medium text-[14px] leading-normal flex items-center justify-center gap-[8px] hover:bg-[#1a3163] transition-colors border-[1.9px] border-[#223F7F]">
